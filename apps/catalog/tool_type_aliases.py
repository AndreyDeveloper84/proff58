...
* первая подтверждённая итерация — ровно 2 alias; третий (ENRICH-WRITE-PATH-
  HARDENING, окно 2026-08-03) — «Оснастка и расходники» → «Оснастка и
  расходные материалы» (см. osnastka-mechanism-preflight-report.md).
"""
