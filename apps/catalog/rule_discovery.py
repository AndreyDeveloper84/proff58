...
PATTERNS: tuple[Pattern, ...] = (
    ...
    _p(
        ...
        "number",
        "м",
        # Наивная версия ловит «350Нм», «10 мм», «5 мАч» — ровно та ошибка,
        # ради которой в отчёте есть колонка ложных срабатываний.
        r"(\d+(?:[.,]\d+)?)\s*м",
        r"(?<![\d.,])(\d+(?:[.,]\d+)?)\s*м" + _UNIT_TAIL,
        note="наивная версия ловит «350Нм», «16 мм», «2 мАч»",
    ),
    _p(
        "pcs",
        "N шт",
