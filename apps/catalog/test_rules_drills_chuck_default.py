...
CASES = [
    # ВАЖНО: enrich_attributes подаёт правилам original_name (имя из 1С), где «Шуруп. аккум.» —
    # эти формы и держат кейсы ниже; витринные названия проверяются рядом.
    ("Шуруп. аккум. Hanskonner HCD1865BL 18В 65Нм 2акк 2,4Ач, бесщ", "bystrozazhimnoy"),
    ("Шуруп. аккум. РЕСАНТА ДА-18-2ЛК-У (Li-ion) ударный", "bystrozazhimnoy"),
    ("Винтоверт аккум THORVIK бесщеточный 20В  260Нм BSI20126 2акк", "bystrozazhimnoy"),
    # витринные формы
    ...
    # сетевой шуруповёрт: напряжения нет, вывод не делается (обе формы имени)
    ("Шуруповёрт сетев. СШ-550-1 РЕСАНТА", None),
    ("Шуруп. сетев.СШ-550-1 РЕСАНТА", None),
    # дрель в форме 1С — тоже без вывода
    ("Дрель ударная аккум. Einhell PXC TC-ID 18 Li 18В без АКБ", None),
]
