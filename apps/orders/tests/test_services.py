...
def test_place_order_initial_statuses(cart_with_item):
    order = place_order(cart_with_item, user=None, customer_data={"customer_name": "Гость", "customer_phone": "+79990099099"})
...
def test_total_equals_sum_of_line_totals(cart, product, product2):
    ...
    order = place_order(cart, user=None, customer_data={"customer_name": "Гость", "customer_phone": "+79990099099"})
...
def test_cart_becomes_ordered(cart_with_item):
    place_order(cart_with_item, user=None, customer_data={"customer_name": "Гость", "customer_phone": "+79990099099"})
...
def test_place_order_empty_cart_raises(cart):
    with pytest.raises(ValidationError):
        place_order(cart, user=None, customer_data={"customer_name": "Гость", "customer_phone": "+79990099099"})
