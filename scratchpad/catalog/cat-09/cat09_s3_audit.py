...
rollback = json.load(io.open("/tmp/cat09-s3-rollback.json", encoding="utf-8"))
...
print(json.dumps({
    "yashchiki-sumki_total": cnt("yashchiki-sumki"),
    "yashchiki-sumki_pub": cnt("yashchiki-sumki", True),
