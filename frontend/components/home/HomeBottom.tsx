...
//
// Карточка email-подписки убрана вместе с ней: рассылки нет и в планах ближайшего
// релиза не было, а неактивные поле и кнопка на главной читались как поломка сайта.
// Вернуть — когда появится backend подписок (тогда же вернуть HOME_CONTENT.subscribe).
