...
витрины MVP (#6). Живой эталон — бывшие страницы `/demo/ui` (kitchen-sink) и `/demo/screens` (удалены 24.09.2026, T6; см. историю git)
...
`next build` — зелёные. (Страницы `/demo/*` удалены 24.09.2026.)
